function create_menu(basepath)
{
	...
	document.write(
		...
		'<ul>' +
			...
			'<li><a href="'+base+'changelog.html">変更履歴(英語)</a></li>' +
		...
		'<ul>' +
			...
			'<li><a href="'+base+'installation/index.html">インストールの解説</a></li>' +
		...
		'<h3>一般的なトピック</h3>' +
		'<ul>' +
			'<li><a href="'+base+'general/index.html">はじめよう</a></li>' +
		...
		'<li><a href="'+base+'libraries/validation.html">バリデーション(検証)クラス</a></li>' +
		...
		'<h3>その他の情報源</h3>' +
		'<ul>' +
		'<li><a href="'+base+'general/quick_reference.html">クイックリファレンスチャート</a></li>' +
